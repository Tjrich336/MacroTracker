					...
					<>
						<div className="button_container">
							<button
								...
								onClick={() => resetFoodItems(authUser.email)}>
								Reset
							</button>
							...
							</button>{" "}
							{
								<DisplayGraphModal
									...
									data={totalMarco}
									goal={macroGoalDetails}></DisplayGraphModal>
							}
						</div>
					</>
				) : (
			...
			<div className="macro-goals-container">
				<div className="macro-goal-box">
					...
					<div className="macro-goal-box-content">
						{isSettingMacroGoals
							? ""
							: calculatePercentage(foodTotals.calories, macroGoalDetails.calories)}
					</div>
				</div>
				<div className="macro-goal-box">
					...
					<div className="macro-goal-box-content">
						{isSettingMacroGoals
							? ""
							: calculatePercentage(foodTotals.protein, macroGoalDetails.protein)}
					</div>
				</div>
				<div className="macro-goal-box">
					...
					<div className="macro-goal-box-content">
						{isSettingMacroGoals
							? ""
							: calculatePercentage(foodTotals.carbs, macroGoalDetails.carbs)}
					</div>
				</div>
				<div className="macro-goal-box">
					...
					<div className="macro-goal-box-content">
						{isSettingMacroGoals
							? ""
							: calculatePercentage(foodTotals.fats, macroGoalDetails.fats)}
					</div>
				</div>
			</div>
